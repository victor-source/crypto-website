<?php include "includes/sidenav.php";?>
        ...
        <div class="main">
           ...
           <div class="row">
                <div class="col">
                    <h4>You can refer your colleagues to join our platform by sharing the affiliate link bellow:</h4>
                    <p><b>Link: </b> <input type="text" id="address" value="https://websitename.com?ref=<?php echo $show['username'];?>"></p>
                    <button class="btn btn-primary" onclick="copy()">Copy Referral Link</button>
                    <script>
                function copy() {
                  /* Get the text field */
                    ...
                    <div class="card mb-3">
                        <div class="card-header">
                            <div class="caption uppercase">
                                <i class="ti-briefcase"></i> My Affiliate Center
                            </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-hover" id="dt-addrows">
                                    ...
                                    <tbody>
                                        <?php
                                        $trans = $conn->query("select * from users where referral='$user'");
                                        foreach($trans as $tran){
                                        ?>
                                        <tr>
                                            <td><?php echo $tran['fullname']?></td>
                                            <td><?php echo $tran['email']?></td>
                                            <td><?php echo $tran['regdata']?></td>
                                        </tr>
                                        <?php }?>
                                    </tbody>
                                </table>
