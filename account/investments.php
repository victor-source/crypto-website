                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-bordered table-hover" id="dt-addrows">
                                    ...
                                    <tbody>
                                        <?php
                                        $trans = $conn->query("select * from deposits where email='$user'");
                                        ...
                                        <tr>
                                            ...
                                            <td><?php if($tran['status']==0){?><button type="button" class="btn btn-warning">pending</button><?php }else if($tran['status']==1){?><button type="button" class="btn btn-primary">ongoing</button><?php }else if($tran['status']==2){?><button type="button" class="btn btn-success">completed</button><?php }?></td>
                                        </tr>
                                        <?php }?>
                                    </tbody>
                                </table>
