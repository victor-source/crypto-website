...
try {
                                                                                ...
                                                                                <tr style="vertical-align:top">
                                                                                    <td style="word-break:break-word;border-collapse:collapse!important;vertical-align:top;background-color:transparent;padding-top:0;padding-right:20px;padding-bottom:20px;padding-left:20px">
                                                                                        <div style="font-size:12px;line-height:14px;text-align:center;color:#555555;font-family:-apple-system,BlinkMacSystemFont,sans-serif">
                                                                                            <p style="margin:0;font-size:12px;line-height:14px;text-align:center">p2p coindex Payment Notification
                                                                                            
                                                                                            </p><p>This is to notify you that the seller has made payment to your escrow trading room with room ID #'.$room.' on P2Pcoindex. Basic details can be seen below:</p>
                                                                                        </div>
                                                                                    </td>
                                                                                </tr>
                                                                                <tr style="vertical-align:top">
                                                                                                        ...
                                                                                                        <div style="color:#fdfffe;line-height:150%;font-family:-apple-system,BlinkMacSystemFont,sans-serif">
                                                                                                            <div style="padding-bottom:40px">
                                                                                                                <p style="margin:0 auto;max-width:300px;font-size:5px;line-height:18px;text-align:center">
                                                                                                                    <span style="font-size:18px;line-height:20px">Payment Amount</span>
                                                                                                                </p>
                                                                                                                <p style="margin:0;font-size:14px;line-height:17px;text-align:center;padding-top:10px">
                                                                                                                    <span style="font-size:36px;line-height:43px">
                                                                                                                        <strong>
                                                                                                                            <span style="line-height:43px;font-size:36px">'.$qty.' '.$coin.' </span>
                                                                                                                        </strong>
                                                                                                                    </span>
                                                                                                                    <br>
                                                                                                                </p>
                                                                                                        ...
                                                                                                        <div style="color:#555555;line-height:120%;font-family:-apple-system,BlinkMacSystemFont,sans-serif">
                                                                                                            <div style="font-size:14px;line-height:17px;text-align:left;color:#555555;font-family:-apple-system,BlinkMacSystemFont,sans-serif;border-bottom:solid 1px #ededed;padding-top:15px;padding-right:10px;padding-bottom:15px;padding-left:10px">
                                                                                                                <p style="margin:0;font-size:14px;line-height:17px;text-align:left">Room ID&nbsp;
                                                                                                                    <strong style="float:right">'.$room.'</strong>
                                                                                                                    <br>
                                                                                                                </p>
                                                                                                            </div>
                                                                                                        </div>
                                                                                                        ...
                                                                                                        <div style="color:#555555;line-height:120%;font-family:-apple-system,BlinkMacSystemFont,sans-serif">
                                                                                                            <div style="font-size:14px;line-height:17px;text-align:left;color:#555555;font-family:-apple-system,BlinkMacSystemFont,sans-serif;border-bottom:solid 1px #ededed;padding-top:15px;padding-right:10px;padding-bottom:15px;padding-left:10px">
                                                                                                                <p style="margin:0;font-size:14px;line-height:17px;text-align:left">Asset Withdrawn&nbsp;
                                                                                                                    <strong style="float:right">'.$coin.'</strong>
                                                                                                                    <br>
                                                                                                                </p>
                                                                                                            </div>
                                                                                                        </div>
                                                                                                        ...
                                                                                                        <div style="color:#555555;line-height:120%;font-family:-apple-system,BlinkMacSystemFont,sans-serif">
                                                                                                            <div style="font-size:14px;line-height:17px;text-align:left;color:#555555;font-family:-apple-system,BlinkMacSystemFont,sans-serif;border-bottom:solid 1px #ededed;padding-top:15px;padding-right:10px;padding-bottom:15px;padding-left:10px">
                                                                                                                <p style="margin:0;font-size:14px;line-height:17px;text-align:left">Quantity&nbsp;
                                                                                                                    <strong style="float:right">'.$qty.'</strong>
                                                                                                                    <br>
                                                                                                                </p>
                                                                                                            </div>
                                                                                                        </div>
    ...
    $mail->send();
       header("location:../admin/index.php?room_id=$room");
        } catch (Exception $e) {
